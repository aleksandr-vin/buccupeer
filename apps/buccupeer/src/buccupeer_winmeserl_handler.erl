...
%%% @doc
%%% Event handler of the windows message WM_DEVICECHANGE
%%% managed by winmeserl_event manager.
%%% @end
%%% Created : 20 Nov 2012 by Aleksandr Vinokurov <aleksandr.vin@gmail.com>
%%%-------------------------------------------------------------------
-module(buccupeer_winmeserl_handler).
